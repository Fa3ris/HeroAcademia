...
public class ParisNameIterator implements CityIterator {

	private Paris paris;
	private List<PointOfInterest> cache; 
	
	public ParisNameIterator(Paris paris) {
		this.paris = paris;
	}
	...
	private void sort() {
		this.cache.sort((p1, p2) -> p1.getName().compareToIgnoreCase(p2.getName()));
	}
